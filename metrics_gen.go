...
func (z *CPUMetrics) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 5
	// write "collected"
	err = en.Append(0x85, 0xa9, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64)
	if err != nil {
		return
	}
	err = en.WriteTime(z.CollectedAt)
...
func (z *CPUMetrics) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 5
	// string "collected"
	o = append(o, 0x85, 0xa9, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64)
	o = msgp.AppendTime(o, z.CollectedAt)
	// string "nodes"
	o = append(o, 0xa5, 0x6e, 0x6f, 0x64, 0x65, 0x73)
	o = msgp.AppendInt(o, z.Nodes)
...
func (z *CPUMetrics) Msgsize() (s int) {
	s = 1 + 10 + msgp.TimeSize + 6 + msgp.IntSize + 10
	if z.TimesStat == nil {
		s += msgp.NilSize
	} else {
	...
	for zb0001 > 0 {
		...
		case "byDestination":
			...
			if z.ByDestination == nil {
				z.ByDestination = make(map[string]RPCMetrics, zb0004)
		...
		case "byCaller":
			...
			if z.ByCaller == nil {
				z.ByCaller = make(map[string]RPCMetrics, zb0005)
...
func (z *RPCMetrics) Msgsize() (s int) {
	s = 3 + 12 + msgp.TimeSize + 10 + msgp.IntSize + 15 + msgp.IntSize + 13 + msgp.IntSize + 16 + msgp.IntSize + 16 + msgp.IntSize + 14 + msgp.Int64Size + 14 + msgp.Int64Size + 17 + msgp.Int64Size + 17 + msgp.Int64Size + 9 + msgp.IntSize + 13 + msgp.TimeSize + 11 + msgp.Float64Size + 13 + msgp.Float64Size + 16 + msgp.TimeSize + 11 + msgp.MapHeaderSize
	if z.LastMinute != nil {
		for za0001, za0002 := range z.LastMinute {
			_ = za0002
			s += msgp.StringPrefixSize + len(za0001) + za0002.Msgsize()
...
func (z *RPCStats) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "outgoingBytes":
			...
			zb0001Mask |= 0x80
		case "reconnects":
			z.Reconnects, err = dc.ReadInt()
			if err != nil {
				err = msgp.WrapError(err, "Reconnects")
				return
			}
			zb0001Mask |= 0x100
		default:
...
func (z *RPCStats) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x100) == 0 { // if not omitted
			// write "reconnects"
			err = en.Append(0xaa, 0x72, 0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x73)
			if err != nil {
				return
			}
			err = en.WriteInt(z.Reconnects)
			if err != nil {
				err = msgp.WrapError(err, "Reconnects")
				return
			}
...
func (z *RPCStats) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x100) == 0 { // if not omitted
			// string "reconnects"
			o = append(o, 0xaa, 0x72, 0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x73)
			o = msgp.AppendInt(o, z.Reconnects)
		}
	}
	return
}
...
func (z *RPCStats) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "outgoingBytes":
			...
			zb0001Mask |= 0x80
		case "reconnects":
			z.Reconnects, bts, err = msgp.ReadIntBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Reconnects")
				return
			}
...
func (z *RPCStats) Msgsize() (s int) {
	...
	s += 13 + msgp.Float64Size + 9 + msgp.Int64Size + 16 + msgp.Float64Size + 14 + msgp.Int64Size + 14 + msgp.Int64Size + 11 + msgp.IntSize
	return
}
...
func (z *ReplicationStats) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x100) == 0 { // if not omitted
			// write "putTag"
			err = en.Append(0xa6, 0x70, 0x75, 0x74, 0x54, 0x61, 0x67)
			if err != nil {
				return
			}
			err = en.WriteInt64(z.PutTag)
			if err != nil {
				err = msgp.WrapError(err, "PutTag")
				return
			}
		...
		if (zb0001Mask & 0x80000) == 0 { // if not omitted
			// write "4xx"
			err = en.Append(0xa3, 0x34, 0x78, 0x78)
			if err != nil {
				return
			}
		...
		if (zb0001Mask & 0x100000) == 0 { // if not omitted
			// write "5xx"
			err = en.Append(0xa3, 0x35, 0x78, 0x78)
			if err != nil {
				return
			}
...
func (z *ReplicationStats) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x100) == 0 { // if not omitted
			// string "putTag"
			o = append(o, 0xa6, 0x70, 0x75, 0x74, 0x54, 0x61, 0x67)
			o = msgp.AppendInt64(o, z.PutTag)
		}
		if (zb0001Mask & 0x200) == 0 { // if not omitted
			// string "del"
		...
		if (zb0001Mask & 0x80000) == 0 { // if not omitted
			// string "4xx"
			o = append(o, 0xa3, 0x34, 0x78, 0x78)
			o = msgp.AppendInt64(o, z.Errors4xx)
		}
		if (zb0001Mask & 0x100000) == 0 { // if not omitted
			// string "5xx"
			o = append(o, 0xa3, 0x35, 0x78, 0x78)
...
func (z *ReplicationStats) Msgsize() (s int) {
	...
	s += 13 + msgp.Float64Size + 7 + msgp.Int64Size + 6 + msgp.Int64Size + 9 + msgp.Float64Size + 4 + msgp.Int64Size + 7 + msgp.Int64Size + 4 + msgp.Int64Size + 7 + msgp.Int64Size + 7 + msgp.Int64Size + 10 + msgp.Int64Size + 9 + msgp.Int64Size + 6 + msgp.Int64Size + 11 + msgp.Int64Size + 10 + msgp.Int64Size + 9 + msgp.Int64Size + 12 + msgp.Int64Size + 4 + msgp.Int64Size + 4 + msgp.Int64Size + 9 + msgp.Int64Size
	return
}
...
func (z *ReplicationTargetStats) Msgsize() (s int) {
	s = 1 + 6 + msgp.IntSize + 8 + msgp.Float64Size + 11 + msgp.Float64Size + 10 + z.LastHour.Msgsize() + 9
	if z.LastDay == nil {
		s += msgp.NilSize
	} else {
